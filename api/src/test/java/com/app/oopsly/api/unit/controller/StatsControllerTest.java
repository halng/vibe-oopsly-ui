...
import com.app.oopsly.api.controller.StatsController;
...
class StatsControllerTest {
    ...
    @Test
    void getUserStats_delegates() {
        ApiRes expected = ApiRes.success("ok");
        when(statsService.getUserStats()).thenReturn(expected);
        assertSame(expected, statsController.getUserStats());
        verify(statsService).getUserStats();
    }
}
