...
export const LandingPage: React.FC<LandingPageProps> = ({ onLoginClick }) => {
  return (
    <div className="min-h-screen bg-[#FDFBF7] font-sans selection:bg-[#8BC34A]/20 selection:text-[#558B2F] flex flex-col">
      {/* Header */}
      <header className="px-6 py-4 flex items-center justify-between border-b border-stone-200/50 bg-white/50 backdrop-blur-md sticky top-0 z-50">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-lg bg-[#8BC34A] text-white flex items-center justify-center shadow-sm">
        ...
        <div className="flex items-center gap-4">
          ...
          <button 
            onClick={onLoginClick}
            className="hidden sm:flex items-center gap-2 px-5 py-2 rounded-xl bg-[#8BC34A] hover:bg-[#7CB342] text-white text-sm font-bold shadow-md shadow-[#8BC34A]/20 transition-all cursor-pointer hover:scale-105 active:scale-95"
          >
            Get Started
      ...
      <main className="flex-1">
        <section className="relative px-6 py-24 sm:py-32 overflow-hidden flex flex-col items-center text-center">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[#8BC34A]/10 rounded-full blur-3xl -z-10" />
          ...
          <h1 className="text-5xl sm:text-7xl font-black text-stone-900 tracking-tight max-w-4xl leading-[1.1] mb-8 animate-in fade-in slide-in-from-bottom-6 duration-700 delay-100">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#8BC34A] to-[#689F38]">spaced repetition.</span>
          </h1>
        ...
        <section className="py-24 bg-white px-6">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="p-8 rounded-3xl bg-stone-50 border border-stone-100 flex flex-col items-start hover:shadow-lg transition-shadow">
                <div className="w-12 h-12 rounded-xl bg-[#8BC34A]/20 text-[#558B2F] flex items-center justify-center mb-6">
      ...
      <footer className="bg-stone-50 py-12 px-6 border-t border-stone-200 text-center">
        <div className="flex items-center justify-center gap-2 mb-4">
          <Layers className="w-6 h-6 text-[#8BC34A]" />
