...
export const SubscriptionPage: React.FC<SubscriptionPageProps> = ({ onClose, currentPlan = 'free' }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-[#FDFBF7] overflow-y-auto">
      {/* Header / Nav */}
      <div className="sticky top-0 z-10 bg-[#FDFBF7]/80 backdrop-blur-md border-b border-stone-200 px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-lg bg-[#8BC34A] text-white flex items-center justify-center">
            <Sparkles className="w-4 h-4" />
          </div>
          <span className="font-black text-stone-900 tracking-tight text-lg">Oopsly Pro</span>
        </div>
        <button 
          onClick={onClose}
          className="w-10 h-10 rounded-full bg-stone-100 flex items-center justify-center text-stone-500 hover:text-stone-900 hover:bg-stone-200 transition-colors cursor-pointer"
        >
          <X className="w-5 h-5" />
        </button>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
            ...
            <div className="bg-stone-100 p-1.5 rounded-2xl flex items-center shadow-inner">
              <button
                ...
                className={`px-6 py-2.5 rounded-xl text-sm font-bold transition-all cursor-pointer ${
                  !isYearly ? 'bg-white text-stone-900 shadow-sm' : 'text-stone-500 hover:text-stone-700'
                }`}
              >
                Monthly
              </button>
              <button
                ...
                className={`px-6 py-2.5 rounded-xl text-sm font-bold transition-all cursor-pointer flex items-center gap-2 ${
                  isYearly ? 'bg-[#8BC34A] text-white shadow-sm shadow-[#8BC34A]/20' : 'text-stone-500 hover:text-stone-700'
                }`}
              >
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {/* Basic Plan */}
          <div className="bg-white rounded-3xl p-8 border border-stone-200 shadow-sm flex flex-col relative">
            <h3 className="text-xl font-bold text-stone-900">Basic</h3>
            <p className="text-stone-500 text-sm mt-2">Everything you need to start learning.</p>
            ...
            <button
              ...
              className="w-full py-3.5 rounded-xl bg-stone-100 text-stone-700 font-bold text-sm disabled:opacity-50 transition-colors"
            >
          ...
          {/* Pro Plan */}
          <div className="bg-stone-900 rounded-3xl p-8 border border-stone-800 shadow-2xl flex flex-col relative transform md:-translate-y-4">
          ...
          <div className="bg-white rounded-3xl p-8 border border-stone-200 shadow-sm flex flex-col relative">
            ...
            <p className="text-stone-500 text-sm mt-2">Pay once, learn forever.</p>
            
            <div className="my-6">
              <span className="text-4xl font-black text-stone-900">$199</span>
              <span className="text-stone-500">/once</span>
            </div>
            ...
            <button
              ...
              className="w-full py-3.5 rounded-xl bg-stone-900 hover:bg-stone-800 text-white font-bold text-sm disabled:opacity-50 transition-colors cursor-pointer flex items-center justify-center gap-2"
            >
        ...
        {/* FAQ or Trust Badges */}
        <div className="mt-24 pt-12 border-t border-stone-200 text-center flex flex-col items-center">
